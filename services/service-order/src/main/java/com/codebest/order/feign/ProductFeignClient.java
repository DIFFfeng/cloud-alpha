...
import com.codebest.order.feign.fallback.ProductFeignclientFallback;
import com.codebest.product.bean.Product;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(value = "service-product",fallback = ProductFeignclientFallback.class) // feign 客户端（可以加 url 就给固定给这个地址请求）
